...
bool Sexy::ExtractLoaderBarResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_GUIDE = aMgr.GetImageThrow("IMAGE_GUIDE");
...
Image* Sexy::IMAGE_CONSOLE_IMITATERSEED;
Image* Sexy::IMAGE_CONSOLE_IMITATERSEEDDISABLED;
Image* Sexy::IMAGE_CONSOLE_SEEDPACKET_LARGER;
Image* Sexy::IMAGE_CONSOLE_SEEDS;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_CONSOLE_IMITATERSEED = aMgr.GetImageThrow("IMAGE_CONSOLE_IMITATERSEED");
		IMAGE_CONSOLE_IMITATERSEEDDISABLED = aMgr.GetImageThrow("IMAGE_CONSOLE_IMITATERSEEDDISABLED");
		IMAGE_CONSOLE_SEEDPACKET_LARGER = aMgr.GetImageThrow("IMAGE_CONSOLE_SEEDPACKET_LARGER");
		IMAGE_CONSOLE_SEEDS = aMgr.GetImageThrow("IMAGE_CONSOLE_SEEDS");
...
static void* gResources[] =
{
	...
	&IMAGE_CONSOLE_SEEDPACKET_LARGER,
	...
	&IMAGE_CONSOLE_IMITATERSEED,
	&IMAGE_CONSOLE_IMITATERSEEDDISABLED,
	&IMAGE_ICETRAP,
	&IMAGE_ICETRAP2,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_GUIDE_ID: return "IMAGE_GUIDE";
		...
		case IMAGE_CONSOLE_SEEDS_ID: return "IMAGE_CONSOLE_SEEDS";
		case IMAGE_SEEDPACKET_LARGER_ID: return "IMAGE_SEEDPACKET_LARGER";
		case IMAGE_CONSOLE_SEEDPACKET_LARGER_ID: return "IMAGE_CONSOLE_SEEDPACKET_LARGER";
		...
		case IMAGE_CONSOLE_IMITATERSEED_ID: return "IMAGE_CONSOLE_IMITATERSEED";
		case IMAGE_CONSOLE_IMITATERSEEDDISABLED_ID: return "IMAGE_CONSOLE_IMITATERSEEDDISABLED";
